<div class="row masthead__bg_search_form mt-5 mx-lg-0 mx-1 pt-lg-3 pt-5">
    <form action="{{route('buscar')}}" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 mb-lg-0 mb-5">
            ...
            <div class="col-lg-3 col-md-4 col-sm-12 mb-lg-0 mb-5">
                <select id="neighborhood" name="neighborhood" class="form-select form-select__white_border masthead__input_select">
                    <option value="">Bairro</option>
                </select>
            </div>
            <div class="col-lg-1 col-md-4 col-sm-12 mb-lg-0 mb-5"><button type="submit" class="btn btn-lg text-bg-dark" style="width: 100%"><i class="fa fa-search"></i></button></div>
        </div>
    </form>
</div>
